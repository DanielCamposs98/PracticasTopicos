...
{
    public partial class frmConsultaBono : Form
    {
        public frmConsultaBono()
        {
            InitializeComponent();
        }
        ...
        private void frmConsultaBono_Load(object sender, EventArgs e)
        {
            ...
            {
                string strCommando = "SELECT emp_id, emp_nom, emp_apar, emp_amar, departamento, bon_total FROM EMPLEADOS" +
